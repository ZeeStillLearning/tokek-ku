            ...
            <div class="col-md-12">
                <div class="card mt-4">
                    <div class="card-header" style="background-color: black">
                        <h5 class="card-title mb-0" style="color: #ffd900; font-weight:bold; display: flex; justify-content: center; align-items: center;">Detail Penjualan</h5>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                        ...
                        <a href="{{ route('kasir.index') }}" class="btn btn-warning mt-3">Kembali</a>
                    </div>
                </div>
            </div>
        </div>
